-- 🎨 SAYU 전시 데이터 60-71번 (수정 버전)
-- email, website_url 컬럼 제거
-- 실행일: 2025-08-31
...
INSERT INTO exhibitions_translations (
  ...
  venue_name, city, operating_hours, ticket_info, address
) 
SELECT id, 'ko',
  '패치워크!',
  ARRAY['박선호', '사토 토모코', '아오야기 나츠미', '임지지'],
  '이미지 조각들과 파편적 말들로 비가시적인 감각과 비선형적 서사의 가능성을 길어올린다.',
  '더 월로', '서울', '화-일 11:00-18:00', '무료',
...
INSERT INTO exhibitions_translations (
  exhibition_id, language_code,
  exhibition_title, artists, description,
  venue_name, city, operating_hours, ticket_info, address, phone_number
) 
SELECT id, 'ko',
  '에클립세',
  ARRAY['지미 로버트'],
  '지미 로버트의 국내 첫 개인전. 가려지는 순간 드러나는 새로운 형상과 리듬, 보이지 않는 틈에서 발생하는 또 다른 가능성을 내포합니다.',
  '바라캇 컨템포러리', '서울', '화-일 10:00-18:00', '무료',
  '서울 종로구 삼청로 58-4', '02-780-1949'
...
SELECT id, 'ko',
  ...
  '서울시립 미술아카이브', '서울', '화-금 10:00-20:00', '무료',
  '서울특별시 종로구 평창문화로 101', '02-2124-7400'
...
SELECT id, 'ko',
  ...
  '세화미술관', '서울', '화-일 10:00-18:00', '성인 15,000원',
  '서울특별시 종로구 새문안로 68'
...
SELECT id, 'ko',
  ...
  '세화미술관', '서울', '화-일 10:00-18:00', '통합 관람',
...
SELECT id, 'ko',
  ...
  '화이트스톤갤러리', '서울', '화-일 11:00-19:00', '무료',
  '서울시 용산구 소월로 70', '02-318-1012'
...
SELECT id, 'ko',
  ...
  '글래드스톤갤러리', '서울', '화-토 10:00-18:00', '무료',
  '서울시 강남구 삼성로 760', '02-6218-0760'
...
SELECT id, 'ko',
  ...
  '아름지기', '서울', '화-토 10:00-18:00', '성인 10,000원',
  '서울 종로구 통의동 아름지기 사옥'
...
SELECT id, 'ko',
  ...
  '대림미술관', '서울', '화-일 10:00-18:00', '무료 (예약 필수)',
  '서울시 종로구 자하문로4길 21'
...
SELECT id, 'ko',
  ...
  '국립현대미술관 서울', '서울', '화-일 10:00-18:00, 수·토 10:00-21:00', '2,000원',
  '서울 종로구 삼청로 30'
