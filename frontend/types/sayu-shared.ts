...
export const SAYU_TYPES: Record<SAYUTypeCode, SAYUType> = {
  ...
  SAEC: {
    ...
    challenges: ['그룹 활동에 집중하다 보니 개인적인 감상 시간이 부족할 수 있습니다', '체계적 공유에 중점을 두다 보니 개인적 깊이 있는 분석은 상대적으로 적을 수 있습니다', '함께하는 경험을 중시하다 보니 가끔은 혼자만의 시간도 필요할 수 있습니다'],
  ...
  SRMF: {
    ...
    challenges: ['자유로운 전달 방식에 집중하다 보니 체계적 구성이 부족할 수 있습니다', '풍부한 지식을 나누다 보니 가끔은 핵심에 집중하는 것도 필요할 수 있습니다', '깊은 내용을 전달하다 보니 듣는 사람의 수준을 더 고려하면 좋겠습니다'],
  ...
  SRMC: {
    ...
    challenges: ['교육적 역할에 집중하다 보니 개인적 감상 시간이 부족할 수 있습니다', '완벽한 설명을 추구하다 보니 가끔은 여유로운 감상도 필요할 수 있습니다', '체계적 접근을 중시하다 보니 때로는 유연한 대응도 도움이 될 수 있습니다'],
