...
const providerConfig = {
  google: {
    ...
    className: 'bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-900 dark:text-gray-100 border border-gray-900 dark:border-gray-300'
  },
  github: {
    name: 'GitHub',
    icon: (
    ...
    className: 'bg-gray-900 dark:bg-gray-800 hover:bg-gray-800 dark:hover:bg-gray-700 text-white border border-gray-900 dark:border-gray-300'
  },
  apple: {
    name: 'Apple',
    icon: (
    ...
    className: 'bg-black dark:bg-gray-800 hover:bg-gray-900 dark:hover:bg-gray-700 text-white border border-gray-900 dark:border-gray-300'
  },
  discord: {
    name: 'Discord',
    icon: (
    ...
    className: 'bg-[#5865F2] hover:bg-[#4752C4] text-white border border-gray-900 dark:border-gray-300'
  },
  instagram: {
    name: 'Instagram',
    icon: (
    ...
    className: 'bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white border border-gray-900 dark:border-gray-300'
  },
  kakao: {
    name: 'Kakao',
    icon: (
    ...
    className: 'bg-[#FEE500] hover:bg-[#FDD835] text-[#191919] border border-gray-900 dark:border-gray-300'
  }
};
