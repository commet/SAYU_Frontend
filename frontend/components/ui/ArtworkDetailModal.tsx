            ...
            <div className="flex items-center justify-between p-6 border-b border-slate-700">
              ...
              <div className="flex items-center gap-2">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={handleLike}
                  className="p-2 rounded-full bg-slate-800 hover:bg-slate-700 border border-slate-600 transition-colors"
                ...
                >
                  <Bookmark className={`w-5 h-5 ${isSaved ? 'text-green-500 fill-green-500' : 'text-slate-400'}`} />
                </motion.button>
                <motion.button
                  whileHover={{ scale: 1.1 }}
                  whileTap={{ scale: 0.95 }}
            ...
            <div className="flex flex-col lg:flex-row max-h-[calc(90vh-100px)] overflow-y-auto">
              ...
              <div className="lg:w-1/2 p-6 space-y-6">
                ...
                <div>
                  ...
                  <p className="text-lg text-purple-400 mb-1">{artwork.artist}</p>
                ...
                {artwork.matchPercent && (
                  <div className="bg-gradient-to-br from-blue-900/20 to-indigo-900/20 border border-blue-700/30 rounded-xl p-4">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-2xl font-bold text-blue-400">{artwork.matchPercent}%</span>
                    </div>
