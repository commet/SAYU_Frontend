...
import type { CompanionRequest } from '@/types/exhibition-companion';
import { TIME_SLOT_OPTIONS, VIEWING_PACE_OPTIONS, INTERACTION_STYLE_OPTIONS } from '@/types/exhibition-companion';
