...
export function getExhibitionRecommendation(personalityType: string): Exhibition | null {
  const exhibitions: Record<string, Exhibition> = {
    'SRMC': {
      ...
      image: '/images/exhibitions/contemporary-masters.jpg',
      recommendationReason: {
    ...
    'LAEF': {
      ...
      image: '/images/exhibitions/expressionism-colors.jpg',
      recommendationReason: {
    ...
    'SAEF': {
      ...
      image: '/images/exhibitions/interactive-art.jpg',
      recommendationReason: {
    ...
    'LRMC': {
      ...
      image: '/images/exhibitions/still-life-collection.jpg',
      recommendationReason: {
    ...
    'SREF': {
      ...
      image: '/images/exhibitions/urban-landscapes.jpg',
      recommendationReason: {
    ...
    'LAMC': {
      ...
      image: '/images/exhibitions/minimalism-aesthetics.jpg',
      recommendationReason: {
    ...
    'SRAC': {
      ...
      image: '/images/exhibitions/pop-art-revolution.jpg',
      recommendationReason: {
    ...
    'LREF': {
      ...
      image: '/images/exhibitions/impressionism-light.jpg',
      recommendationReason: {
