...
(
  (SELECT id FROM exhibitions_master WHERE venue_id = (SELECT id FROM venues_simple WHERE name_ko = '더 월로') AND start_date = '2025-08-28' ORDER BY created_at DESC LIMIT 1),
  'ko', '패치워크!', NULL,
...
(
  (SELECT id FROM exhibitions_master WHERE venue_id = (SELECT id FROM venues_simple WHERE name_ko = '아뜰리에 아키') AND start_date = '2025-08-28' ORDER BY created_at DESC LIMIT 1),
  'ko', '임현정 개인전', '몸의 풍경',
  ARRAY['임현정'],
...
(
  (SELECT id FROM exhibitions_master WHERE venue_id = (SELECT id FROM venues_simple WHERE name_ko = '아뜰리에 아키') AND start_date = '2025-08-28' ORDER BY created_at DESC LIMIT 1),
  'en', 'Lim Hyun-jung Solo Exhibition', 'Landscape of Body',
  ARRAY['Lim Hyun-jung'],
...
(
  (SELECT id FROM exhibitions_master WHERE venue_id = (SELECT id FROM venues_simple WHERE name_ko = '바라캇 컨템포러리') AND start_date = '2025-08-28' ORDER BY created_at DESC LIMIT 1),
  'ko', '지미 로버트', '멜로디의 윤곽',
  ARRAY['지미 로버트'],
...
(
  (SELECT id FROM exhibitions_master WHERE venue_id = (SELECT id FROM venues_simple WHERE name_ko = '바라캇 컨템포러리') AND start_date = '2025-08-28' ORDER BY created_at DESC LIMIT 1),
  'en', 'Jimmy Robert', 'Contour of Melody',
  ARRAY['Jimmy Robert'],
...
(
  (SELECT id FROM exhibitions_master WHERE venue_id = (SELECT id FROM venues_simple WHERE name_ko = '서울시립 미술아카이브') AND start_date = '2025-08-28' ORDER BY created_at DESC LIMIT 1),
  'ko', '다시, 지구', '기후위기 시대의 예술',
...
(
  (SELECT id FROM exhibitions_master WHERE venue_id = (SELECT id FROM venues_simple WHERE name_ko = '서울시립 미술아카이브') AND start_date = '2025-08-28' ORDER BY created_at DESC LIMIT 1),
  'en', 'Again, Earth', 'Art in the Climate Crisis Era',
...
(
  (SELECT id FROM exhibitions_master WHERE venue_id = (SELECT id FROM venues_simple WHERE name_ko = '상히읗') AND start_date = '2025-08-28' AND exhibition_type = 'solo' ORDER BY created_at DESC LIMIT 1),
  'ko', '이지수', '빛의 기록',
  ARRAY['이지수'],
...
(
  (SELECT id FROM exhibitions_master WHERE venue_id = (SELECT id FROM venues_simple WHERE name_ko = '세화미술관') AND start_date = '2025-08-30' AND genre = 'design' ORDER BY created_at DESC LIMIT 1),
  'ko', '노노탁 스튜디오', '놀이와 디자인의 경계',
  ARRAY['노노탁 스튜디오'],
...
(
  (SELECT id FROM exhibitions_master WHERE venue_id = (SELECT id FROM venues_simple WHERE name_ko = '세화미술관') AND start_date = '2025-08-30' AND genre = 'design' ORDER BY created_at DESC LIMIT 1),
  'en', 'Nonotak Studio', 'Boundary of Play and Design',
...
(
  (SELECT id FROM exhibitions_master WHERE venue_id = (SELECT id FROM venues_simple WHERE name_ko = '세화미술관') AND start_date = '2025-08-30' AND genre = 'contemporary' ORDER BY created_at DESC LIMIT 1),
  'ko', '쿠사마 야요이', '무한의 거울',
  ARRAY['쿠사마 야요이'],
...
(
  (SELECT id FROM exhibitions_master WHERE venue_id = (SELECT id FROM venues_simple WHERE name_ko = '세화미술관') AND start_date = '2025-08-30' AND genre = 'contemporary' ORDER BY created_at DESC LIMIT 1),
  'en', 'Yayoi Kusama', 'Infinity Mirror',
  ARRAY['Yayoi Kusama'],
...
(
  (SELECT id FROM exhibitions_master WHERE venue_id = (SELECT id FROM venues_simple WHERE name_ko = '화이트스톤갤러리') AND start_date = '2025-08-30' ORDER BY created_at DESC LIMIT 1),
  'ko', '헨릭 울달렌', '침묵의 풍경',
  ARRAY['헨릭 울달렌'],
...
(
  (SELECT id FROM exhibitions_master WHERE venue_id = (SELECT id FROM venues_simple WHERE name_ko = '화이트스톤갤러리') AND start_date = '2025-08-30' ORDER BY created_at DESC LIMIT 1),
  'en', 'Henrik Uldalen', 'Silent Landscape',
...
(
  (SELECT id FROM exhibitions_master WHERE venue_id = (SELECT id FROM venues_simple WHERE name_ko = '글래드스톤갤러리') AND start_date = '2025-08-29' ORDER BY created_at DESC LIMIT 1),
  'ko', '우고 론디노네', '푸른 돌, 하얀 구름',
  ARRAY['우고 론디노네'],
...
(
  (SELECT id FROM exhibitions_master WHERE venue_id = (SELECT id FROM venues_simple WHERE name_ko = '글래드스톤갤러리') AND start_date = '2025-08-29' ORDER BY created_at DESC LIMIT 1),
  'en', 'Ugo Rondinone', 'Blue Stone, White Cloud',
  ARRAY['Ugo Rondinone'],
...
(
  (SELECT id FROM exhibitions_master WHERE venue_id = (SELECT id FROM venues_simple WHERE name_ko = '재단법인 아름지기') AND start_date = '2025-08-29' ORDER BY created_at DESC LIMIT 1),
  'ko', '장, 식탁으로 이어진 풍경', '한국 발효 문화의 미학',
  ARRAY['김덕호', '이헌정', '박성욱'],
...
(
  (SELECT id FROM exhibitions_master WHERE venue_id = (SELECT id FROM venues_simple WHERE name_ko = '재단법인 아름지기') AND start_date = '2025-08-29' ORDER BY created_at DESC LIMIT 1),
  'en', 'Jang, Landscape Connected to the Table', 'Aesthetics of Korean Fermentation Culture',
...
(
  (SELECT id FROM exhibitions_master WHERE venue_id = (SELECT id FROM venues_simple WHERE name_ko = '대림미술관') AND start_date = '2025-08-29' ORDER BY created_at DESC LIMIT 1),
  'ko', '페트라 콜린스', '드림 월드',
  ARRAY['페트라 콜린스'],
...
(
  (SELECT id FROM exhibitions_master WHERE venue_id = (SELECT id FROM venues_simple WHERE name_ko = '국립현대미술관 서울') AND start_date = '2025-08-29' ORDER BY created_at DESC LIMIT 1),
  'ko', '올해의 작가상 2025', '비가시적 세계의 재현',
...
(
  (SELECT id FROM exhibitions_master WHERE venue_id = (SELECT id FROM venues_simple WHERE name_ko = '국립현대미술관 서울') AND start_date = '2025-08-29' ORDER BY created_at DESC LIMIT 1),
  'en', 'Korea Artist Prize 2025', 'Representation of the Invisible World',
...
WHERE et.language_code = 'ko' 
  AND et.venue_name LIKE '%국립현대미술관%'
GROUP BY et.venue_name;